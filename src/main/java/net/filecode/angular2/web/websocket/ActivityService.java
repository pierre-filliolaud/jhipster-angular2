package net.filecode.angular2.web.websocket;

import net.filecode.angular2.security.SecurityUtils;
import net.filecode.angular2.web.websocket.dto.ActivityDTO;
...
import static net.filecode.angular2.config.WebsocketConfiguration.IP_ADDRESS;
