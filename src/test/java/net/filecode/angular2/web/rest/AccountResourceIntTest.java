...
import net.filecode.angular2.domain.Authority;
import net.filecode.angular2.domain.User;
import net.filecode.angular2.repository.AuthorityRepository;
import net.filecode.angular2.repository.UserRepository;
import net.filecode.angular2.security.AuthoritiesConstants;
import net.filecode.angular2.service.MailService;
import net.filecode.angular2.service.UserService;
import net.filecode.angular2.service.dto.UserDTO;
import net.filecode.angular2.web.rest.vm.ManagedUserVM;
